                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                                            <a class="edit-modal" data-id="{{$heure->id}}" class="btn btn-xs btn-white btn-icon-only width-auto">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <a class="delete-modal " data-id="{{$heure->id}}" style="color: red" class="btn btn-xs btn-red btn-icon-only width-auto">
