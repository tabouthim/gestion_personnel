<div id="updateModalEmploye" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form method="post" action="{{route('employe.update')}}">
        {{ csrf_field() }}
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myModalLabel">Modifier un employe</h5>
                ...
                <div class="modal-body">
                    ...
                    <select name="contrat" value="{{$employe->contrat}}">
                        <option> </option>
                        <option>CDI</option>
                        <option>CDD</option>
                    </select><br>
                    ...
                    <select name="situation_marital" value="{{$employe->situation_marital}}">
                        <option> </option>
                        <option>marié</option>
                        <option>celibataire</option>
                    </select><br>
                    <label style="width: 150px"> sexe</label>
                    <select name="sexe" value="{{$employe->sexe}}">
                        <option> </option>
